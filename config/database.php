...
return [
  ...
  'default' => env('DB_CONNECTION', 'pusat'),
  ...
  'connections' => [
    ...
    'pusat' => [
      ...
      'database' => env('DB_DATABASE', 'pusatdb'),
    ...
    'nilai_sdk13' => [
      ...
      'password' => env('DB_PASSWORD_SD', 'pahoa'),
      'unix_socket' => env('DB_SOCKET', ''),
      'charset' => 'utf8mb4',
      'collation' => 'utf8mb4_unicode_ci',
      'prefix' => '',
    ...
    'nilai_smp' => [
      ...
      'password' => env('DB_PASSWORD_SMP', 'pahoa'),
      'unix_socket' => env('DB_SOCKET', ''),
      'charset' => 'utf8mb4',
      'collation' => 'utf8mb4_unicode_ci',
      'prefix' => '',
    ...
    'nilai_sma_2017' => [
      ...
      'password' => env('DB_PASSWORD_SMA', 'pahoa'),
      'unix_socket' => env('DB_SOCKET', ''),
      'charset' => 'utf8mb4',
      'collation' => 'utf8mb4_unicode_ci',
      'prefix' => '',
