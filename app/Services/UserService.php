...
class UserService
{
  ...
  protected $applicationCategoryRepo;
  ...
  public function __construct(
    ...
    ApplicationCategoriesRepository $applicationCategoryRepo
  ) {
    ...
    $this->applicationCategoryRepo = $applicationCategoryRepo;
  }
    ...
    if ($careers) {
      foreach ($careers as $item) {
        array_push($units, [
          ...
          'position_parent'    =>  $item->positions->parent,
          'unit_id'            =>  $item->positions->employeeunit->id,
          'unit_name'          =>  $item->positions->employeeunit->name,
          'unit_type_id'       =>  $item->positions->employeeunit->employee_unit_type_id,
          'unit_type_value'    =>  $item->positions->employeeunit->employeeunitype->name,
