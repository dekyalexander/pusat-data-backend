...
class TahunPelajaranController extends Controller
{
  ...
  public function updateTahunPelajaran(Request $request)
  {
    try {
      ...
      $tahunPelajaranSebelumnya = $this->tahunPelajaranService->getTahunPelajaranActive()->pluck('id')->first();
      $this->tahunPelajaranService->offTahunPelajaran($tahunPelajaranSebelumnya);
